...
# This can be downloaded from https://drive.google.com/file/d/0Bz7KyqmuGsilT0J5dmRCM0ROVHc/view
...
def main():
    ...
    # Write to file the most confident answer
