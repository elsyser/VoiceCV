...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_json', default='prepro/data_prepro.json', help='output json file')
    parser.add_argument('--output_h5', default='prepro/data_prepro.h5', help='output h5 file')
